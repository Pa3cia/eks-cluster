...
proxy_address           = "fpa-prod.aws.telekom.de:3128"
...
ingress_controller_alb   = true
ingress_controller_nginx = false
...
map_roles = [
  {
    rolearn  = "arn:aws:iam::<---aws-account-id--->:role/ADFS_DTIT_Project_Admin"
